...
void ExportOptions::Load(QSettings *pSettings)
{
    ...
    nHyphenate = pSettings->value(QStringLiteral("hyphenate"), 0).toInt();
    nVignette = pSettings->value(QStringLiteral("Vignette"), 0).toInt();
    ...
    nFootNotes = pSettings->value(QStringLiteral("footnotes"), 0).toInt();
    ...
    nMaxCaptionLevel = pSettings->value(QStringLiteral("MAXcaptionLevel"), 2).toInt();
